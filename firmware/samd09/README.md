...
The same generated image is also written as a versioned raw binary below `firmware/samd09/images/<mode>/`, for example
`firmware/samd09/images/i2c/vue2-i2c-v1.0.bin`.
